...
import nuxt_plugin_plugin_4db531dc from 'nuxt_plugin_plugin_4db531dc' // Source: .\\components\\plugin.js (mode: 'all')
import nuxt_plugin_bootstrapvue_13018138 from 'nuxt_plugin_bootstrapvue_13018138' // Source: .\\bootstrap-vue.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Balance Period","titleTemplate":"Balance Period Web","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_4db531dc === 'function') {
    await nuxt_plugin_plugin_4db531dc(app.context, inject)
  }

  if (typeof nuxt_plugin_bootstrapvue_13018138 === 'function') {
    await nuxt_plugin_bootstrapvue_13018138(app.context, inject)
  }
